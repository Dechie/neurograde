          ...
          <div className="space-y-8">
            <div className="flex gap-6">
              <div className="flex-shrink-0">
                <div className="text-lg w-10 h-10 rounded-full bg-primary text-primary-foreground flex items-center justify-center font-bold">
                  1.
                </div>
              </div>
              <div>
            ...
            <div className="flex gap-6">
              ...
              <div>
                <h3 className="text-lg font-bold [#primary] mb-2">
                  Submit Your Code
                </h3>
                <p className="text-muted-foreground">
